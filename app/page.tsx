      ...
      <div className="relative">
        ...
        <main className="w-full relative">
          ...
          <section className="relative w-full flex flex-col items-center justify-center mx-auto">
            ...
            <h1 className="text-center font-conthrax-book pt-8 text-4xl ">Companies and Creators <br /> we’ve worked with</h1>

            <div className="w-full h-full flex justify-center  p-12">
              <Avatar className="scale-42 left-88 shadow-[-6px_0_12px_-1px_rgba(0,0,0,0.5)]" src='/profile-1.png' />
              <Avatar className="scale-48 left-60 shadow-[-6px_0_12px_-1px_rgba(0,0,0,0.5)]" src='/profile-2.png' />
              <Avatar className="scale-58 left-34 shadow-[-6px_0_12px_-1px_rgba(0,0,0,0.5)]" src='/profile-3.png' />
              <Avatar className="scale-66 left-12 shadow-[-6px_0_12px_-1px_rgba(0,0,0,0.5)]" src='/profile-4.png' />
              <Avatar className="scale-110 z-9 shadow-[0px_0_12px_8px_rgba(0,0,0,0.6)]" src='/profile-5.png' />
              <Avatar className="scale-66 -left-12 z-8 shadow-[6px_0_12px_-1px_rgba(0,0,0,0.5)]" src='/profile-6.png' />
              <Avatar className="scale-58 -left-34 z-7 shadow-[6px_0_12px_-1px_rgba(0,0,0,0.5)]" src='/profile-7.png' />
              <Avatar className="scale-48 -left-60 z-6 shadow-[6px_0_12px_-1px_rgba(0,0,0,0.5)]" src='/profile-8.png' />
              <Avatar className="scale-42 -left-88 shadow-[6px_0_12px_-1px_rgba(0,0,0,0.5)]" src='/profile-9.png' />
            </div>


            <div className="flex flex-col gap-y-2">
              <h6 className="text-center font-conthrax text-xl ">The Jesus Conspiracy</h6>
              <h6 className="text-center font-montserrat text-base text-white/50 ">@thejesusconspiracy</h6>
              <h6 className="text-center font-montserrat text-base text-white flex items-center justify-center gap-x-2"><span>                  <div className=" flex items-center justify-center">
